...
0004d600 <CarPlayControlClientEventCallback(CarPlayControlClient const*, unsigned int, void*, void*)@@Base+0x1fb4>:
   4d600:	8b9e50ef          	jal	32eb8 <lv_event_switchto_apmode(_lv_event_t*)@@Base+0xdf8>
   4d604:	989e70ef          	jal	34f8c <CarPlayProxyApp::HWTestThread(void*)@@Base+0x20d0>
